...
const compat_1 = __importDefault(require("../src/rules/compat"));
...
ruleTester.run("compat", compat_1.default, {
    valid: [
    ...
    invalid: [
      ...
      `,
        ...
        },
        {
            ...
            errors: [
                {
                    message: "Promise.allSettled() is not supported in Safari 12, Chrome 72",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            errors: [
                {
                    message: "WebAssembly is not supported in Safari 10.1, Opera 12.1, iOS Safari 10.3, IE 10, Edge 14",
                    type: "MemberExpression",
                },
            ],
        },
