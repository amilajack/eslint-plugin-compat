...
const repos = [
    {
        name: "bootstrap",
        location: path_1.default.join(projectRoot, reposDir, "bootstrap"),
        remoteLink: "https://github.com/twbs/bootstrap.git",
        targetCommitId: "7a6da5e3e7ad7c749dde806546a35d4d4259d965",
        targetGitRef: "v4.5.0",
        filePatterns: [path_1.default.join("js", "src"), path_1.default.join("js", "tests"), "build"],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "bootstrap"),
            useEslintrc: false,
            baseConfig: {
    ...
    },
    {
        ...
        location: path_1.default.join(projectRoot, reposDir, "electron-react-boilerplate"),
        remoteLink: "https://github.com/electron-react-boilerplate/electron-react-boilerplate.git",
        targetCommitId: "c240ecabaffb3ddfcb32c7b1970eedb4027caeec",
        targetGitRef: "v1.1.0",
        filePatterns: ["."],
        browserslist: ["electron 7.1.13"],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "electron-react-boilerplate"),
    ...
    {
        name: "handlebars.js",
        location: path_1.default.join(projectRoot, reposDir, "handlebars.js"),
        remoteLink: "https://github.com/handlebars-lang/handlebars.js.git",
        targetCommitId: "e6ad93ea01bcde1f8ddaa4b4ebe572dd616abfaa",
        targetGitRef: "v4.7.6",
        filePatterns: ["."],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "handlebars.js"),
            extensions: [".js"],
            useEslintrc: false,
            baseConfig: {
                extends: ["plugin:compat/recommended"],
    ...
    {
        name: "jquery",
        location: path_1.default.join(projectRoot, reposDir, "jquery"),
        ...
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "jquery"),
            extensions: [".js"],
            useEslintrc: false,
            baseConfig: {
                extends: ["plugin:compat/recommended"],
    ...
    {
        name: "preact",
        location: path_1.default.join(projectRoot, reposDir, "preact"),
        remoteLink: "https://github.com/preactjs/preact.git",
        targetCommitId: "1834cd70adf5758541d6167ba8c2c42778443d04",
        targetGitRef: "10.4.4",
        filePatterns: ["*.js"],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "preact"),
            extensions: [".js"],
            useEslintrc: false,
            baseConfig: {
                parser: "@typescript-eslint/parser",
    ...
    // },
    {
        ...
        location: path_1.default.join(projectRoot, reposDir, "create-react-app"),
        ...
        filePatterns: ["."],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "create-react-app"),
            extensions: [".js"],
            useEslintrc: false,
            baseConfig: {
                root: true,
    ...
    {
        name: "aframe",
        location: path_1.default.join(projectRoot, reposDir, "aframe"),
        remoteLink: "https://github.com/aframevr/aframe.git",
        targetCommitId: "781b6abb47d572c1e52add53166f35e4a876908c",
        targetGitRef: "v1.0.4",
        filePatterns: ["."],
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "aframe"),
            extensions: [".js"],
            useEslintrc: false,
            baseConfig: {
                extends: ["plugin:compat/recommended"],
    ...
    {
        name: "pixi.js",
        location: path_1.default.join(projectRoot, reposDir, "pixi.js"),
        ...
        eslintOptions: {
            cwd: path_1.default.join(projectRoot, reposDir, "pixi.js"),
            extensions: [".js", ".ts"],
            useEslintrc: false,
            baseConfig: {
                root: true,
...
async function initRepo({ targetCommitId, remoteLink, location }, showLogs = true) {
    const benchmarksAbsPath = path_1.default.join(projectRoot, reposDir);
    if (!(0, fs_1.existsSync)(benchmarksAbsPath)) {
        (0, fs_1.mkdirSync)(benchmarksAbsPath);
    }
    if (showLogs)
        console.log(`Retrieving ${remoteLink}`);
    const git = (0, simple_git_1.default)();
    // Clone if necessary, else use existing repo
    if (!(0, fs_1.existsSync)(path_1.default.join(location, ".git"))) {
        if (showLogs)
