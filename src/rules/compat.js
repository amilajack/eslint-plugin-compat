...
function isUsingTranspiler(context) {
    ...
    if (context.parserOptions?.tsconfigRootDir === true)
        return true;
    const dir = context.getFilename();
    const configPath = find_up_1.default.sync(items, {
        cwd: dir,
    });
    if (configPath)
        return true;
...
exports.default = {
    ...
    create(context) {
        ...
        const browserslistTargets = (0, helpers_1.parseBrowsersListVersion)((0, helpers_1.determineTargetsFromConfig)(context.getFilename(), browserslistConfig));
